    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                <a href="{{ route('frontSite.home') }}" class="footer_last_part_menu">Home</a>
{{--                <a href='{{ url("Contact_us.html") }}' class="footer_last_part_menu">About</a>--}}
                <a href='#' class="footer_last_part_menu">About</a>
                <a href='{{ route('frontSite.contact') }}' class="footer_last_part_menu">Contact</a>
                <a href='{{ route('frontSite.blog') }}' class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
