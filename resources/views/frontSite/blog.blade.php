                ...
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7 animate-box">
                            <a href='{{ url('single') }}' class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
                        ...
                        <div class="col-md-5">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img">
                                    <img src='{{ asset("images/photo-1449157291145-7efd050a4d0e-578x362.jpg") }}' alt=""/>
                                </div>
                                <div></div>
                            </div>
                        </div>
                    ...
                    <div class="row pb-4">
                        <div class="col-md-5">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src='{{ asset("images/office-768x512.jpg") }}' alt=""/></div>
                                <div></div>
                            </div>
                        </div>
                        <div class="col-md-7">
